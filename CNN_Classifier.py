...
from tensorflow.keras.layers import Dense, Dropout, Activation, Flatten ,GaussianDropout
...
class CNN_Classifier:
    ...
    def define_model(self):
        ...
        model = Sequential()
        model.add(Conv2D(128,kernel_size, strides=stride_size, padding='same', activation='relu', input_shape=self.img_shape))
